...
@Slf4j
@RestController
@RequestMapping(path = "/api/contact",produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.APPLICATION_PROBLEM_XML_VALUE})
@CrossOrigin(origins = "*")
public class ContactRestController {

    @Autowired
    JpaContactRepository contactRepository;
