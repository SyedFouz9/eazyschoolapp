...
import com.eazybites.eazyschool.model.Courses;
import com.eazybites.eazyschool.model.EazyClass;
import com.eazybites.eazyschool.model.Person;
import com.eazybites.eazyschool.repository.CoursesRepository;
import com.eazybites.eazyschool.repository.EazyClassRepository;
...
public class AdminController {
    ...
    public ModelAndView displayStudents(@RequestParam int classId, HttpSession session, @RequestParam(value = "error", required = false)
    String error) {
